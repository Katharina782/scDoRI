...
gene_names = pd.read_pickle(r"/omics/groups/OE0533/internal/katharina/scDoRI/gastrulation_data/jupyter_notebooks/gene_names.pkl")
...
corr_expr_scores = rowwise_correlation(expr_agg, score_agg, N)


# In[ ]:


corr_expr_p2g_scores = rowwise_correlation(expr_agg, score_agg, N)


corr_scores = rowwise_correlation(scores_p2g_agg, score_agg, N)
