...
```{r}
p2g_original <- p2g
p2g <- p2g %>% as.data.frame() %>% filter(Correlation > 0)
```
...
```{r}
scores <- gene_activity_scores(peak_mat, p2g_mat)
...
writeH5AD(sce, "/omics/groups/OE0533/internal/katharina/scDoRI/gastrulation_data/jupyter_notebooks/p2g_gene_activity_scores/debugging7",
          X_name = "scores")
```
