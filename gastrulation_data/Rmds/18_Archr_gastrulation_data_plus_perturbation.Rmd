...
proj <- addUMAP(ArchRProj = proj, reducedDims = "atac_LSI", 
                     force = TRUE, verbose = FALSE)
```


Can we add a pca object by simply adding a folder including a pca matrix?

```{r}

proj <- addUMAP(ArchRProj = proj, reducedDims = "pca")
```
